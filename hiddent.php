...
<html>
    ...
    <body>
        ...
        <center>
            <h1>This level is called <b>The Idiot Test</b></h1>
             <h3><a href="welcome.php" class="btn btn-warning">Back to Map</a>
             <br>
             <a href="logout.php" class="btn btn-danger">Log Out</a></h3>
            <h2>(If you can't complete it, learn how to do HTML and come back to do it.)</h2>
            <h4>Find out the password <!--password:@helloworld-->and you may continue.</h4>
            <div class="box">
                <div></div>
                <div></div>
                <div></div>
            ...
            <div class="container">
                ...
                <form class="login_form" action="home.php" method="post" name="form" onsubmit="return myfun()">
                    <div class="font font2"></div>
                    <input autocomplete="off" type="password" id="password" value="">
                    <span id="messages" style="color: red;"></span>
                    <br>
                    
                    <button type="submit" <?php if($_SESSION["t1"]==1){
